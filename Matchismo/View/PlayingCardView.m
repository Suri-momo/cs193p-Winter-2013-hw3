...
#define CARD_CURVE 12.0
#define FONT_PERCENT 0.20
#define UPPER_CARD_X 2.0
#define UPPER_CARD_Y 2.0
...
{
    // Drawing Code
    UIBezierPath *roundedRect = [UIBezierPath bezierPathWithRoundedRect:self.bounds cornerRadius:CARD_CURVE];
...
- (void)drawCorners
{
    ...
    UIFont *cornerFont = [UIFont systemFontOfSize:self.bounds.size.width * FONT_PERCENT];
    ...
    CGRect textBounds;
    textBounds.origin = CGPointMake(UPPER_CARD_X, UPPER_CARD_Y);
